// *********************
// Role of the component: IntroducingSection with the text "Introducing Our Store"
// Name of the component: IntroducingSection.tsx
// Developer: 
// Version: 1.0
// Component call: <IntroducingSection />
// Input parameters: no input parameters
// Output: Section with the text "Introducing Our Store" and button
// *********************
    ...
    <div className="py-20 pt-24 bg-gradient-to-l from-white to-blue-600">
      <div className="text-center flex flex-col gap-y-5 items-center">
        <h2 className="text-white text-8xl font-extrabold text-center mb-2 max-md:text-6xl max-[480px]:text-4xl">
          TIENDA <span className="text-black">SHOP</span><span className="text-blue-600">TEST</span>
        </h2>
        <div>
          <p className="text-white text-center text-2xl font-semibold max-md:text-xl max-[480px]:text-base">
            Compra los últimos productos electrónicos.
          </p>
          <p className="text-white text-center text-2xl font-semibold max-md:text-xl max-[480px]:text-base">
            Los mejores productos para amantes de la tecnología.
          </p>
